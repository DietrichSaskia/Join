                ...
                <form id="editContactForm">
                    <div class="EditwindowInputDeleteSave">
                        ...
                        <div class="EditWindowDeleteSave" id="EditWindowDeleteSaveID1">
                            ...
                            <button id="EditNewContactButtonID" onclick="editNewContactSave2(${index})" class="EditWindowSaveButton">Save <img class="EditSaveCheck" src="/assets/icons/checkWhite.png"></button>
                        </div>
